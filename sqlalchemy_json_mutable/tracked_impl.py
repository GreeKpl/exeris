...
class TrackedObject(object):
    ...
    def register(cls, origin_types):
        ...
        The provided class or list of `origin_types` is mapped to the decorated class such that
        future calls to `convert()` will convert the object of `origin_types` to an
        instance of the decorated class.
        """
        if inspect.isclass(origin_types):
